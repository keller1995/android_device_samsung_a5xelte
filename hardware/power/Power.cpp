...
void Power::setProfile(SecPowerProfiles profile) {
    ...
    if (data->cpu.enabled)
    {
        ...
        if (data->cpu.cluster1.enabled) {
            Utils::write("/sys/devices/system/cpu/cpu0/cpufreq/scaling_governor", data->cpu.cluster1.governor);
            ...
            Utils::write("/sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq", data->cpu.cluster1.freq_min);
            Utils::write("/sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq", data->cpu.cluster1.freq_max);

            Utils::write("/sys/devices/system/cpu/cpu0/online", data->cpu.cluster1.cores.core1);
            Utils::write("/sys/devices/system/cpu/cpu1/online", data->cpu.cluster1.cores.core2);
            Utils::write("/sys/devices/system/cpu/cpu2/online", data->cpu.cluster1.cores.core3);
            Utils::write("/sys/devices/system/cpu/cpu3/online", data->cpu.cluster1.cores.core4);
        ...
        if (data->cpu.cluster2.enabled) {
            Utils::write("/sys/devices/system/cpu/cpu4/cpufreq/scaling_governor", data->cpu.cluster2.governor);
            ...
            // make sure our limits are being applied to the then-limiting,
            // not very reliable, files too
            Utils::write("/sys/devices/system/cpu/cpu4/cpufreq/scaling_min_freq", data->cpu.cluster2.freq_min);
            Utils::write("/sys/devices/system/cpu/cpu4/cpufreq/scaling_max_freq", data->cpu.cluster2.freq_max);

            Utils::write("/sys/devices/system/cpu/cpu4/online", data->cpu.cluster2.cores.core1);
            Utils::write("/sys/devices/system/cpu/cpu5/online", data->cpu.cluster2.cores.core2);
            Utils::write("/sys/devices/system/cpu/cpu6/online", data->cpu.cluster2.cores.core3);
            Utils::write("/sys/devices/system/cpu/cpu7/online", data->cpu.cluster2.cores.core4);
    ...
    if (data->gpu.enabled) {
        if (data->gpu.dvfs.enabled) {
            /* GPU Min/Max clock rate locks */
            Utils::write("/sys/devices/11400000.mali/dvfs_min_lock",   data->gpu.dvfs.min_lock);
            Utils::write("/sys/devices/11400000.mali/dvfs_max_lock",   data->gpu.dvfs.max_lock);
        }
...
//TODO: Does not exist in our device?
